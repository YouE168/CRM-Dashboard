      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
            ...
            <p className="text-xs text-gray-500">{programs.length} programs</p>
          </div>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <input
                                ...
                                onChange={(e) => {
                                  const updated =
                                    selectedProgram.upcomingSessions.map((s) =>
                                      s.id === session.id
                            ...
                            .map((p, idx) => (
                              ...
                              >
                                ...
                                <td className="py-2 px-3">
                                  <span
                                    className={`text-xs px-2 py-0.5 rounded-full ${
                                      p.businessProfessionalStatus ===
                                        "approved" ||
                                      p.businessProfessionalStatus === "active"
                                        ? "bg-green-100 text-green-700"
                                        : p.businessProfessionalStatus ===
                                            "rejected"
                                  ...
                                  >
                                    {p.businessProfessionalStatus || "pending"}
                                  </span>
                                </td>
                                <td className="py-2 px-3">
                                  <div className="flex gap-2">
                          ...
                          <div className="flex items-start gap-3">
                            <div className="flex-1">
                              <input
                                ...
                                value={resource.name}
                                onChange={(e) => {
                                  const updated = selectedProgram.resources.map(
                                    (r) =>
                                      r.id === resource.id
